...
/* Exported types ------------------------------------------------------------*/
/* Exported constants --------------------------------------------------------*/
#define MAX_CURRENT 5.5             /* max current value, Amps MAX_CURRENT=3.3/(2*Rshunt*Av)*/
...
#define FINAL_START_UP_SPEED      (u16) 1000 //Rotor mechanical speed (rpm)
...
#define FIRST_I_STARTUP           (u16) 2979 
#define FINAL_I_STARTUP           (u16) 5957 //I(digit)= I(Amps)*Rshunt*Av*65536/3.3
#define I_START_UP_DURATION       (u16) 3000 //in msec
...
#define SLESS_I_ALIGNMENT           (u16) 5958 //7412
...
#define MINIMUM_SPEED_RPM             (u16) 100	 //580
